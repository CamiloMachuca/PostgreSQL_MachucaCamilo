...
select row_number() over(order by id), id, username from usuarios;
-- select table usuarios add constraint fk_username foreign key(usuario) references credenciales(usuario);
...
select substring('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf', round(random()* length('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf'))::integer,1);

select string_agg(substring('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf', round(random()* length('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf'))::integer,1),
'') as paswwordd from generate_series(1, 30);


select generate_series(1,10);
-- drop function generate_ramdon_password;
-- funcion retorna una tabla
create function generate_ramdon_password(long INTEGER)
returns table(password text) as $$
BEGIN
	return query select string_agg(substring('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf', round(random()* length('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf'))::integer,1),
	'') as paswwordd from generate_series(1, long);

END;
$$ LANGUAGE plpgsql;

select generate_ramdon_password(5);


-- funcion retorna text
create function generate_ramdon_password1(long INTEGER)
returns text as $$
BEGIN
	return (select string_agg(substring('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf', round(random()* length('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf'))::integer,1),
	'') as paswwordd from generate_series(1, long));

END;
$$ LANGUAGE plpgsql;

select generate_ramdon_password1(5);

-- funcion retorna text
-- drop function generate_ramdon_password2;
create function generate_ramdon_password2(long INTEGER)
returns text as $$
declare textoo text;
BEGIN
	
	textoo=(select string_agg(substring('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf', round(random()* length('asdfghrytjvbdufurhsjdhfkdjfhfbfhuelopuf'))::integer,1),
	'') as paswwordd from generate_series(1, long));
	return textoo;
...
select md5(password) from credenciales;




select generate_ramdon_password2(5);
update credenciales set password= generate_ramdon_password1(12);
update credenciales set password_sha = sha512(password::bytea); --where usuario='brush99';
select * from credenciales;

-- retorna una fila porque esta bien el usuario y contraseña
select * from credenciales where sha512('jrfbshhrdekh')= password_sha and usuario='talk39';
select * from credenciales;

-- no retorna una fila porque esta bien el usuario y contraseña
select * from credenciales where sha512('jrfbshhrde')= password_sha and usuario='talk3';
...
INSERT INTO usuarios (nombre, apellido, correo, ip, ubicacion, blog, usuario, seguidores, siguiendo) VALUES
